...
O repositorio `Gait_Predition_History` reune cerca de dois anos de pesquisa sobre coleta e analise de marcha usando IMU/MPU6050, ESP32, MQTT, Unity, Python, MATLAB e modelos de machine learning.
